/*
 * Stoatworks Labs - About window data for Contourtonist.
 *
...
{
    inline constexpr auto name = "Contourtonist";
    inline constexpr auto slug = "contourtonist";
    inline constexpr auto hook = "Equal-loudness EQ that tracks the room";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/contourtonist/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/contourtonist/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/contourtonist";
